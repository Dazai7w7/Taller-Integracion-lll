  ...
  return (
    <div className='container'>
        <form>
            ...
            <label htmlFor='lastname'>Horario</label>
            <input type="text" id="lastname" onChange={handleChange} name="horario" value={body.horario}/>

            <label htmlFor='email'>Descripcion</label>
            <input type="email" id="email"  name='descripcion' value={body.descripcion} onChange={handleChange}/>
